...
import com.noti.common.constant.NotipushConstant;
import com.noti.common.domain.TaskInfo;
import com.noti.common.dto.model.ContentModel;
import com.noti.common.enums.ChannelType;
...
public class AssembleAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        try {
            ...
            if (!messageTemplate.isPresent() || messageTemplate.get().getIsDeleted().equals(NotipushConstant.TRUE)) {
