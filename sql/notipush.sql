...
-- 实时类型 短信（无占位符）
INSERT INTO notipush.message_template (id, name, audit_status, flow_id, msg_status, cron_task_id, cron_crowd_path,
                                     ...
                                     updated)
VALUES (1, '买一送十活动', 10, '', 10, null, '', '', 30, 30, 20, 20, '{"content":"6666","url":"","title":""}', 10, 'Javaxhyyxl',
        'Javaxhyyxl', 'xhyyxl', '公众号Javaxhyyxl', '三歪', 0, 1646274112, 1646275242);
...
VALUES (2, '校招信息', 10, '', 10, null, '', '', 50, 40, 20, 10, '{"content":"你已成功获取到offer","url":"","title":"招聘通知"}', 10,
        'Javaxhyyxl', 'Javaxhyyxl', 'xhyyxl', '公众号Javaxhyyxl', '鸡蛋', 0, 1646274195, 1646274195);
...
VALUES (3, '验证码通知', 10, '', 10, null, '', '', 30, 30, 20, 30, '{"content":"{$content}","url":"","title":""}', 10,
        'Javaxhyyxl', 'Javaxhyyxl', 'xhyyxl', '公众号Javaxhyyxl', '孙悟空', 0, 1646275213, 1646275213);
